...
<div class="container">
    ...
    <form action="<?php echo e(route($route, isset($event->user_id) ? $event->user_id : null)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php if($method === 'put'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hp\Desktop\laravel1pro\example-app\resources\views/event/form_event.blade.php ENDPATH**/ ?>